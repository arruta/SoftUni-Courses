...
public class CurrencyServiceImpl implements CurrencyService {
    ...
    public void refreshRates(ExchangeRatesDTO exchangeRatesDTO) {
        ...
        LOGGER.info("Exchange rate received {}", exchangeRatesDTO);
    ...
    public MoneyDTO convert(ConvertRequestDTO convertRequestDTO) {
        ExchangeRateEntity exchangeRateEntity =
                exchangeRateRepository.findById(convertRequestDTO.target())
                        .orElseThrow(() -> new ObjectNotFoundException(
                                "Conversion to target " + convertRequestDTO.target() + " not possible!"));
