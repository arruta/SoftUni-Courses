...
public class OfferController {
    ...
    public String add(@Valid CreateOfferDTO createOfferDTO,
        ...
        if (bindingResult.hasErrors()) {
            ...
            rAttr.addFlashAttribute("org.springframework.validation.BindingResult.createOfferDTO", bindingResult);
    ...
    @GetMapping("/{uuid}")
    public String details(@PathVariable("uuid") UUID uuid, Model model, @AuthenticationPrincipal UserDetails viewer) {
    ...
    @DeleteMapping("/{uuid}")
    public String deleteOffer(@PathVariable("uuid") UUID uuid, @AuthenticationPrincipal UserDetails principal){
